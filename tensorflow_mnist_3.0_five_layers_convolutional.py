...
#
# X = [batch, 28, 28, 1], W1 = [5, 5, 1, 4], b1 = [4], W2 = [5, 5, 4, 8], b2 = [8],
# W3 = [4, 4, 8, 12], b3 = [12], W4 = [7*7*12, 200], b4 = [200], W5 = [200, 10], b5 = [10], Y = [batch, 10]
#
...
def train4(minibatch_size=100, iterations=2000 + 1):
    ...
    for i in range(iterations):
        ...
        if i % 10 == 0:
            acc, cost = sess.run([accuracy, cross_entropy], feed_dict={X: batch_X, Y_: batch_Y, step: i})
    ...
    lrate = sess.run(lr, feed_dict={X: mnist.test.images, Y_: mnist.test.labels, step: iterations - 1})
    ...
    plt.title("Learning rate =" + str(lrate))
    # plt.show()
    outfig = "output/learning_rate " + str(lrate) + " iterations " + str(iterations) + " max test accuracy " + str(
